...
class FetchCurrentData : AppCompatActivity() {
    ...
    fun getCalendarData() {
        val url = "https://calendarific.com/api/v2/holidays?api_key=b3b773212663ecc3ce8726c7fd1fbba694e4fc69&country=" + intent.getStringExtra("code") + "&year=" + intent.getStringExtra("year") + ""
